...
public class Main extends Application 
{
	...
	public void start(Stage window) 
    {
		...
		{	
		    ...
		    //////////////////////////// roba di luca/////////////////////////
		    /*Sphere organo= new Sphere(90);
		    organo.setMaterial(new PhongMaterial(Color.INDIANRED));
		    
					   organo.setTranslateX(0);
					   organo.setTranslateY(400);
			
			Box organo= new Box(300,200,100);
			organo.setTranslateY(400);
			organo.setRotationAxis(Rotate.X_AXIS);
			organo.setRotate(15);
		       		    		    
		    Sphere tumore=new Sphere(30);
		    tumore.setMaterial(new PhongMaterial(Color.LIGHTYELLOW));
		    do{
		    	x=(Math.random()*400);
		    	y=(Math.random()*400);
		    	z=(Math.random()*400);
		    	tumore.getTransforms().addAll(
			    		new Translate(x,y,z));
		    } while (!(tumore.getBoundsInParent().intersects(organo.getBoundsInParent())));
		    	tumore.setTranslateX(90);
		    	tumore.setTranslateY(400);
		    	tumore.setTranslateZ(50);
		    			
		    
		    	//tumore.setVisible(false);
		    	
		    Sphere test= new Sphere(31);
		    test.getTransforms().add(new Translate(tumore.getTranslateX(),tumore.getTranslateY(),tumore.getTranslateZ()));
		   */ /////////////////////////////////////// fine roba luca ////////////////////////////////
		    		   
		    root3D.getChildren().add(world);
		    //root3D.getChildren().add(organo);
		    //root3D.getChildren().add(tumore);
	        ...
	        keyboard.handleKeyboard1(guiScene, Simulation.LEFT_ARM, Simulation.RIGHT_ARM, axisMesh, Simulation.PATIENT, Simulation.TISSUE);
